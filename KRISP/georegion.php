...
$FIPS = array (
	...
	"KR" => array (
					"01" => "Jeju-do",							# Á¦ÁÖµµ
					"03" => "Jeollabuk-do",						# Àü¶óºÏµµ
					"05" => "Chungcheongbuk-do",				# ÃæÃ»ºÏµµ
					"06" => "Gangwon-do",						# °­¿øµµ
					"10" => "Busan Metropolitan City",			# ºÎ»ê ±¤¿ª½Ã
					"11" => "Seoul Metropolitan Government",	# ¼­¿ï Æ¯º°½Ã
					"12" => "Incheon Metropolitan City",		# ÀÎÃµ ±¤¿ª½Ã
					"13" => "Gyeonggi-do",						# °æ±âµµ
					"14" => "Gyeongsangbuk-do",					# °æ»óºÏµµ
					"15" => "Daegu Metropolitan City",			# ´ë±¸ ±¤¿ª½Ã
					"16" => "Jeollanam-do",						# Àü¶ó³²µµ
					"17" => "Chungcheongnam-do",				# ÃâÃ»³²µµ
					"18" => "Gwangju Metropolitan City",		# ±¤ÁÖ ±¤¿ª½Ã
					"19" => "Daejeon Metropolitan City",		# ´ëÀü ±¤¿ª½Ã
					"20" => "Gyeongsangnam-do",					# °æ»ó³²µµ
					"21" => "Ulsan Metropolitan City"			# ¿ï»ê ±¤¿ª½Ã
	),
	"KW" => array (
					"01" => "Al Ahmadi",
					"02" => "Al Kuwayt",
