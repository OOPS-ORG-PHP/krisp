...
$FIPS = array (
	...
	"KR" => array (
					"01" => "Jeju-do",							# 제주도
					"03" => "Jeollabuk-do",						# 전라북도
					"05" => "Chungcheongbuk-do",				# 충청북도
					"06" => "Gangwon-do",						# 강원도
					"10" => "Busan Metropolitan City",			# 부산 광역시
					"11" => "Seoul Metropolitan Government",	# 서울 특별시
					"12" => "Incheon Metropolitan City",		# 인천 광역시
					"13" => "Gyeonggi-do",						# 경기도
					"14" => "Gyeongsangbuk-do",					# 경상북도
					"15" => "Daegu Metropolitan City",			# 대구 광역시
					"16" => "Jeollanam-do",						# 전라남도
					"17" => "Chungcheongnam-do",				# 출청남도
					"18" => "Gwangju Metropolitan City",		# 광주 광역시
					"19" => "Daejeon Metropolitan City",		# 대전 광역시
					"20" => "Gyeongsangnam-do",					# 경상남도
					"21" => "Ulsan Metropolitan City"			# 울산 광역시
	),
	"KW" => array (
					"01" => "Al Ahmadi",
					"02" => "Al Kuwayt",
